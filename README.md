...
You may provide input to be processed by Xerataus AI (“Input”), and receive output generated and returned by the Xerataus AI based on the Input (“Output”). Input and Output are your Content or Customer Data, as applicable. You will ensure that your Input and use of the Xerataus AI will not violate any applicable law. You are solely responsible for the development, content, operation, maintenance, and use of your Content and Customer Data.
...
You acknowledge that for the purposes of your participation in the AIM DYNAMIX AI Program and your use of Xerataus AI, Xerataus uses additional subprocessor(s) to provide the Xerataus AI functionality.
