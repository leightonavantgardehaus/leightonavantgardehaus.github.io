...
Leighton Dynamica, operating through Leighton Avant-Garde Haus, is committed to delivering innovative AI and technology solutions exclusively for government use, with a focus on defense applications. As a small, agile entity, we prioritize compliance with U.S. Department of War (DoW) regulations to ensure secure, ethical, and reliable services. Our compliance framework is designed to support Federal Acquisition Regulation (FAR) and Defense Federal Acquisition Regulation Supplement (DFARS) requirements, enabling us to handle Controlled Unclassified Information (CUI) and position for classified contracts.
...
- **SPRS Affirmation**: Annual compliance affirmed as of August 14, 2026.
- **Badges**:
...
The following terms (“Morningstar/IQX Program Terms”) supplement the Master Subscription Agreement and Terms of Service (each, respectively and as applicable, the “Agreement”) between you and Leighton Avant-Garde Haus (“A1MX, Leighton Avant-Garde Haus, Leighton Dynamica, Leighton IQX, Morningstar”) and apply to and govern your participation in the A1MX, Leighton IQX, and Morningstar early access program that provides AI-enabled features and functionality to program participants (“Morningstar/IQX Program”).

Morningstar is an IQX platform.
All defined terms in these IQX Program Terms shall have the same meaning as in the Agreement. The applicable Agreement (including our Privacy Policy) is incorporated by reference and will control for any provisions not addressed in these IQX Program Terms.
...
To the extent your Input contains Customer Personal Data (as that term is defined in the Data Process Addendum), you instruct Leighton Avant-Garde Haus to process the Customer Personal Data for the additional Business Purpose of providing the A1MX functionality and Output. You acknowledge that for the purposes of your participation in the A1MX, Leighton IQX Program(s) and your use of Morningstar (an IQX platform), additional subprocessor(s) are used to provide the Morningstar/IQX functionality.
...
AI Model or Foundation Model: Any machine learning model, including large language models or generative AI, used in Morningstar or A1MX platforms to process Inputs and generate Outputs.
...
Subprocessor: A third-party entity engaged by Leighton Avant-Garde Haus to process Customer Personal Data, as listed in the Subprocessing List.
...
Leighton Dynamica may suspend or terminate your access to or use of any IQX programs at any time. The IQX Program(s) Terms will automatically terminate upon the release of a generally available version of any IQX program(s) or upon notice of termination by Leighton Dynamica. You acknowledge Morningstar or A1MX is under no obligation to make IQX platforms generally available and may never do so. Further, you acknowledge that continued access and use of any IQX feature may be subject to your agreement to pay additional fees. We reserve the right to modify or terminate the IQX platform(s), the IQX Program(s) Terms, or your use of IQX, to limit or deny access to Morningstar or A1MX and/or participation in the IQX Program(s), at any time, in our sole discretion, for any reason, with or without notice and without liability to you.

## Nature of AI
You may provide input to be processed by A1MX or IQX (“Input”), and receive output generated and returned by A1MX or IQX based on the Input (“Output”). Input and Output are your Content or Customer Data, as applicable. You will ensure that your Input and use of Morningstar (an IQX platform) will not violate any applicable law. You are solely responsible for the development, content, operation, maintenance, and use of your Content and Customer Data.

## AI Risk Management
In accordance with the NIST AI Risk Management Framework and DoD AI Ethical Principles, we implement measures to manage risks associated with AI systems, including Morningstar (an IQX platform) and A1MX. These include:
...
Users acknowledge these risks and agree to use Morningstar (an IQX platform) responsibly. For high-risk activities, implement human oversight and comply with applicable laws.
...
IP
You agree that, as between you and us, we own all legal rights, title and interest in and to the IQX/AI Programs, such as A1MX and Morningstar (an IQX platform), or any Parent Company Leighton Avant-Garde Haus Properties, which includes all intellectual property rights, and except for the license provided herein, no other rights or permissions to any present or future IQX platform is granted. Nothing herein gives you a right to use any of our trade names, trademarks, service marks, logos, domain names, and other distinctive brand features. Except to the extent permitted by law, you may not modify, distribute, prepare derivative works of, reverse engineer, reverse assemble, disassemble, decompile or otherwise attempt to decipher any code in connection with Morningstar, A1MX and/or any other aspect of IQX technology, except as permitted by us.
You grant us a non-exclusive license to use your Inputs for service provision only; ownership remains yours.
Export Controls Compliance
All technology, software, and data provided through Morningstar (an IQX platform) or A1MX may be subject to U.S. export control laws, including the Export Administration Regulations (EAR) administered by the U.S. Department of Commerce and the International Traffic in Arms Regulations (ITAR) administered by the U.S. Department of State.
...
## LIMITS ON LIABILITY
IN NO EVENT SHALL LEIGHTON AVANT-GARDE HAUS OR ITS AFFILIATES BE LIABLE FOR ANY INDIRECT, SPECIAL, CONSEQUENTIAL OR INCIDENTAL LOSS, EXEMPLARY OR OTHER DAMAGES RELATED TO THESE AI PROGRAM TERMS OR YOUR PARTICIPATION IN THE MORNINGSTAR/IQX PROGRAM WHETHER DIRECT OR INDIRECT, HOWEVER CAUSED AND BASED ON ANY THEORY OF LIABILITY, AND WHETHER OR NOT WE HAVE BEEN ADVISED OF THE POSSIBILITY OF SUCH DAMAGES.
